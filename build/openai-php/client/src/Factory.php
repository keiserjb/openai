...
namespace BackdropOpenAI\OpenAI;

use Closure;
use Exception;
use BackdropOpenAI\GuzzleHttp\Client as GuzzleClient;
use BackdropOpenAI\Http\Discovery\Psr18ClientDiscovery;
use BackdropOpenAI\OpenAI\Transporters\HttpTransporter;
use BackdropOpenAI\OpenAI\ValueObjects\ApiKey;
...
use BackdropOpenAI\Symfony\Component\HttpClient\Psr18Client;
final class Factory
{
    /**

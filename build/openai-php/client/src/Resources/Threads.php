...
use BackdropOpenAI\OpenAI\Contracts\Resources\ThreadsContract;
use BackdropOpenAI\OpenAI\Contracts\Resources\ThreadsMessagesContract;
use BackdropOpenAI\OpenAI\Contracts\Resources\ThreadsRunsContract;
use BackdropOpenAI\OpenAI\Responses\StreamResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\Runs\ThreadRunResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\Runs\ThreadRunStreamResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\ThreadDeleteResponse;
...
final class Threads implements ThreadsContract
{
    ...
    public function createAndRunStreamed(array $parameters): StreamResponse
    {
        ...
        $payload = Payload::create('threads/runs', $parameters);
        $response = $this->transporter->addHeader('OpenAI-Beta', 'assistants=v2')->requestStream($payload);

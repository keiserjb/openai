...
namespace BackdropOpenAI\OpenAI\Responses\Realtime\Tools;
...
final class FunctionTool implements ResponseContract
{
     ...
     * @param  'function'  $type
     */
    private function __construct(public readonly string $description, public readonly string $name, public readonly array $parameters, public readonly string $type)
    {
    }
    /**
    ...
    {
        return new self(description: $attributes['description'], name: $attributes['name'], parameters: $attributes['parameters'], type: $attributes['type']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['description' => $this->description, 'name' => $this->name, 'parameters' => $this->parameters, 'type' => $this->type];
    }
}

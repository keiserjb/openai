...
final class WebSearchUserLocation implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $type, public readonly ?string $city, public readonly string $country, public readonly ?string $region, public readonly ?string $timezone)
    {
    }
    /**
    ...
    {
        return new self(type: $attributes['type'], city: $attributes['city'], country: $attributes['country'], region: $attributes['region'], timezone: $attributes['timezone']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['type' => $this->type, 'city' => $this->city, 'country' => $this->country, 'region' => $this->region, 'timezone' => $this->timezone];
    }
}

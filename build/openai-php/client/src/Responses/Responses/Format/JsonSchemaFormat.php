...
namespace BackdropOpenAI\OpenAI\Responses\Responses\Format;
...
final class JsonSchemaFormat implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $name, public readonly array $schema, public readonly string $type, public readonly ?string $description, public readonly ?bool $strict = null)
    {
    }
    /**
    ...
    {
        return new self(name: $attributes['name'], schema: $attributes['schema'], type: $attributes['type'], description: $attributes['description'] ?? null, strict: $attributes['strict'] ?? null);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['name' => $this->name, 'schema' => $this->schema, 'type' => $this->type, 'description' => $this->description, 'strict' => $this->strict];
    }
}

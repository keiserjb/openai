...
final class McpApprovalResponse implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $approvalRequestId, public readonly bool $approved, public readonly string $id, public readonly string $type, public readonly ?string $reason = null)
    {
    }
    /**
    ...
    {
        return new self(approvalRequestId: $attributes['approval_request_id'], approved: (bool) $attributes['approve'], id: $attributes['id'], type: $attributes['type'], reason: $attributes['reason'] ?? null);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['type' => $this->type, 'approval_request_id' => $this->approvalRequestId, 'approve' => $this->approved, 'id' => $this->id, 'reason' => $this->reason];
    }
}

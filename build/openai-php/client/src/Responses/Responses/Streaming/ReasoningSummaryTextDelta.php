...
final class ReasoningSummaryTextDelta implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    private function __construct(public readonly string $delta, public readonly string $itemId, public readonly int $outputIndex, public readonly int $summaryIndex, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    {
        return new self(delta: $attributes['delta'], itemId: $attributes['item_id'], outputIndex: $attributes['output_index'], summaryIndex: $attributes['summary_index'], meta: $meta);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['delta' => $this->delta, 'item_id' => $this->itemId, 'output_index' => $this->outputIndex, 'summary_index' => $this->summaryIndex];
    }
}

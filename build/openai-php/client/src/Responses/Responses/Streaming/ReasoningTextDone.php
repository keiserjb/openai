...
final class ReasoningTextDone implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    private function __construct(public readonly int $contentIndex, public readonly string $itemId, public readonly int $outputIndex, public readonly int $sequenceNumber, public readonly string $text, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    {
        return new self(contentIndex: $attributes['content_index'], itemId: $attributes['item_id'], outputIndex: $attributes['output_index'], sequenceNumber: $attributes['sequence_number'], text: $attributes['text'], meta: $meta);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['content_index' => $this->contentIndex, 'item_id' => $this->itemId, 'output_index' => $this->outputIndex, 'sequence_number' => $this->sequenceNumber, 'text' => $this->text];
    }
}

...
final class ImageGenerationPartialImage implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    private function __construct(public readonly int $outputIndex, public readonly string $itemId, public readonly int $sequenceNumber, public readonly int $partialImageIndex, public readonly string $partialImageB64, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    {
        return new self(outputIndex: $attributes['output_index'], itemId: $attributes['item_id'], sequenceNumber: $attributes['sequence_number'], partialImageIndex: $attributes['partial_image_index'], partialImageB64: $attributes['partial_image_b64'], meta: $meta);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['output_index' => $this->outputIndex, 'item_id' => $this->itemId, 'sequence_number' => $this->sequenceNumber, 'partial_image_index' => $this->partialImageIndex, 'partial_image_b64' => $this->partialImageB64];
    }
}

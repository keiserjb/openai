...
final class OutputMcpListToolsTool implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $name, public readonly array $inputSchema, public readonly ?string $description = null, public readonly ?array $annotations = null)
    {
    }
    /**
    ...
    {
        return new self(name: $attributes['name'], inputSchema: $attributes['input_schema'], description: $attributes['description'] ?? null, annotations: $attributes['annotations'] ?? null);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['name' => $this->name, 'input_schema' => $this->inputSchema, 'description' => $this->description, 'annotations' => $this->annotations];
    }
}

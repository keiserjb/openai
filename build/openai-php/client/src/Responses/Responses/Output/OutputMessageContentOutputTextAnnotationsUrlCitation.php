...
final class OutputMessageContentOutputTextAnnotationsUrlCitation implements ResponseContract
{
     ...
     */
    private function __construct(public readonly int $endIndex, public readonly int $startIndex, public readonly string $title, public readonly string $type, public readonly string $url)
    {
    }
    /**
    ...
    {
        return new self(endIndex: $attributes['end_index'], startIndex: $attributes['start_index'], title: $attributes['title'], type: $attributes['type'], url: $attributes['url']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['end_index' => $this->endIndex, 'start_index' => $this->startIndex, 'title' => $this->title, 'type' => $this->type, 'url' => $this->url];
    }
}

...
final class OutputCustomToolCall implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $callId, public readonly string $input, public readonly string $name, public readonly string $id, public readonly string $type)
    {
    }
    /**
    ...
    {
        return new self(callId: $attributes['call_id'], input: $attributes['input'], name: $attributes['name'], id: $attributes['id'], type: $attributes['type']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['type' => $this->type, 'call_id' => $this->callId, 'input' => $this->input, 'name' => $this->name, 'id' => $this->id];
    }
}

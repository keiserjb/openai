...
final class OutputFileSearchToolCallResult implements ResponseContract
{
     ...
     */
    private function __construct(public readonly array $attributes, public readonly string $fileId, public readonly string $filename, public readonly float $score, public readonly string $text)
    {
    }
    /**
    ...
    {
        return new self(attributes: $attributes['attributes'], fileId: $attributes['file_id'], filename: $attributes['filename'], score: $attributes['score'], text: $attributes['text']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['attributes' => $this->attributes, 'file_id' => $this->fileId, 'filename' => $this->filename, 'score' => $this->score, 'text' => $this->text];
    }
}

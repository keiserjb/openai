...
final class OutputComputerActionDoubleClick implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $type, public readonly float $x, public readonly float $y)
    {
    }
    /**
    ...
    {
        return new self(type: $attributes['type'], x: $attributes['x'], y: $attributes['y']);
    }
    /**
     * {@inheritDoc}
     */

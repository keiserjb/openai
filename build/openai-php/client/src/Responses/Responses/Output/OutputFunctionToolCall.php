...
final class OutputFunctionToolCall implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $arguments, public readonly string $callId, public readonly string $name, public readonly string $type, public readonly string $id, public readonly string $status)
    {
    }
    /**
    ...
    {
        return new self(arguments: $attributes['arguments'], callId: $attributes['call_id'], name: $attributes['name'], type: $attributes['type'], id: $attributes['id'], status: $attributes['status']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['arguments' => $this->arguments, 'call_id' => $this->callId, 'name' => $this->name, 'type' => $this->type, 'id' => $this->id, 'status' => $this->status];
    }
}

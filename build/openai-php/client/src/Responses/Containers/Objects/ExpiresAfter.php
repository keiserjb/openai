...
namespace BackdropOpenAI\OpenAI\Responses\Containers\Objects;
...
final class ExpiresAfter implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $anchor, public readonly int $minutes)
    {
    }
    /**
    ...
    {
        return new self(anchor: $attributes['anchor'], minutes: $attributes['minutes']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['anchor' => $this->anchor, 'minutes' => $this->minutes];
    }
}

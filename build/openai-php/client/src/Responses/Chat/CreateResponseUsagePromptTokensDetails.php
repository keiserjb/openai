...
{
    private function __construct(public readonly ?int $audioTokens, public readonly int $cachedTokens)
    {
    }
    /**
    ...
    {
        return new self($attributes['audio_tokens'] ?? null, $attributes['cached_tokens'] ?? 0);
    }
    /**

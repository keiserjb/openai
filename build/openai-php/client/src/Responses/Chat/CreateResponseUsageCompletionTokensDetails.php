...
{
    private function __construct(public readonly ?int $audioTokens, public readonly ?int $reasoningTokens, public readonly ?int $acceptedPredictionTokens, public readonly ?int $rejectedPredictionTokens)
    {
    }
    /**
    ...
    {
        return new self($attributes['audio_tokens'] ?? null, $attributes['reasoning_tokens'] ?? null, $attributes['accepted_prediction_tokens'] ?? null, $attributes['rejected_prediction_tokens'] ?? null);
    }
    /**

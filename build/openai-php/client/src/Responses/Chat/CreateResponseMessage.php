...
final class CreateResponseMessage
{
     ...
     */
    private function __construct(public readonly string $role, public readonly ?string $content, public readonly array $annotations, public readonly array $toolCalls, public readonly ?CreateResponseFunctionCall $functionCall, public readonly ?CreateResponseChoiceAudio $audio = null)
    {
    }
    /**
    ...
    public static function from(array $attributes): self
    {
        ...
        $annotations = array_map(fn(array $result): CreateResponseChoiceAnnotations => CreateResponseChoiceAnnotations::from($result), $attributes['annotations'] ?? []);
        return new self($attributes['role'], $attributes['content'] ?? null, $annotations, $toolCalls, isset($attributes['function_call']) ? CreateResponseFunctionCall::from($attributes['function_call']) : null, isset($attributes['audio']) ? CreateResponseChoiceAudio::from($attributes['audio']) : null);
    }
    /**

...
final class BatchResponseRequestCounts implements ResponseContract
{
     ...
     */
    use ArrayAccessible;
    private function __construct(public int $total, public int $completed, public int $failed)
    {
    }
    /**
    ...
    {
        return new self($attributes['total'], $attributes['completed'], $attributes['failed']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['total' => $this->total, 'completed' => $this->completed, 'failed' => $this->failed];
    }
}

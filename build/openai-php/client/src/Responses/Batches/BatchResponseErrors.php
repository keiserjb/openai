...
final class BatchResponseErrors implements ResponseContract
{
     ...
     */
    private function __construct(public string $object, public array $data)
    {
    }
    /**
    ...
    {
        return new self($attributes['object'], array_map(fn(array $data): \BackdropOpenAI\OpenAI\Responses\Batches\BatchResponseErrorsData => BatchResponseErrorsData::from($data), $attributes['data']));
    }
    /**
     * {@inheritDoc}
     */

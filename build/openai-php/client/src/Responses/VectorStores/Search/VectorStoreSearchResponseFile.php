...
namespace BackdropOpenAI\OpenAI\Responses\VectorStores\Search;
...
final class VectorStoreSearchResponseFile implements ResponseContract
{
     ...
     */
    private function __construct(public readonly string $fileId, public readonly string $filename, public readonly float $score, public readonly array $attributes, public readonly array $content)
    {
    }
    /**

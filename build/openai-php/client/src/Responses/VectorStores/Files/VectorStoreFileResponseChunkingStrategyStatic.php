...
final class VectorStoreFileResponseChunkingStrategyStatic implements ResponseContract
{
     ...
     * @param  'static'  $type
     */
    private function __construct(public readonly string $type, public readonly int $maxChunkSizeTokens, public readonly int $chunkOverlapTokens)
    {
    }
    /**
    ...
    {
        return new self($attributes['type'], $attributes['static']['max_chunk_size_tokens'], $attributes['static']['chunk_overlap_tokens']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['type' => $this->type, 'static' => ['max_chunk_size_tokens' => $this->maxChunkSizeTokens, 'chunk_overlap_tokens' => $this->chunkOverlapTokens]];
    }
}

...
final class VectorStoreFileResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        return ['id' => $this->id, 'object' => $this->object, 'usage_bytes' => $this->usageBytes, 'created_at' => $this->createdAt, 'vector_store_id' => $this->vectorStoreId, 'status' => $this->status, 'attributes' => $this->attributes, 'last_error' => $this->lastError instanceof VectorStoreFileResponseLastError ? $this->lastError->toArray() : null, 'chunking_strategy' => $this->chunkingStrategy->toArray()];
    }
}

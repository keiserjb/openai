...
final class AssistantResponseToolResources implements ResponseContract
{
    ...
    use ArrayAccessible;
    use Fakeable;
    private function __construct(public ?AssistantResponseToolResourceCodeInterpreter $codeInterpreter, public ?AssistantResponseToolResourceFileSearch $fileSearch)
    {
    }
    /**
    ...
    {
        return new self(isset($attributes['code_interpreter']) ? AssistantResponseToolResourceCodeInterpreter::from($attributes['code_interpreter']) : null, isset($attributes['file_search']) ? AssistantResponseToolResourceFileSearch::from($attributes['file_search']) : null);
    }
    /**
     * {@inheritDoc}
     */

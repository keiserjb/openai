...
namespace BackdropOpenAI\OpenAI\Responses\Embeddings;
...
final class CreateResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     */
    private function __construct(public readonly string $object, public readonly ?string $model, public readonly array $embeddings, public readonly ?CreateResponseUsage $usage, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    public static function from(array $attributes, MetaInformation $meta): self
    {
        ...
        return new self($attributes['object'], $attributes['model'] ?? null, $embeddings, isset($attributes['usage']) ? CreateResponseUsage::from($attributes['usage']) : null, $meta);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array_filter(['object' => $this->object, 'model' => $this->model ?? null, 'data' => array_map(static fn(CreateResponseEmbedding $result): array => $result->toArray(), $this->embeddings), 'usage' => $this->usage?->toArray()], fn(mixed $value): bool => !is_null($value));
    }
}

...
namespace BackdropOpenAI\OpenAI\Responses\Moderations;

use BackdropOpenAI\OpenAI\Enums\Moderations\Category;
final class CreateResponseResult
{
    ...
    public static function from(array $attributes): self
    {
        ...
        return new CreateResponseResult($categories, $attributes['flagged'], $attributes['category_applied_input_types'] ?? null);
    }
    /**

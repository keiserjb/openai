...
namespace BackdropOpenAI\OpenAI\Responses\Conversations\Objects\MessageTypes;
...
final class ComputerScreenshotContent implements ResponseContract
{
     ...
     */
    private function __construct(public readonly ?string $fileId, public readonly ?string $imageUrl, public readonly string $type)
    {
    }
    /**
    ...
    {
        return new self(fileId: $attributes['file_id'] ?? null, imageUrl: $attributes['image_url'] ?? null, type: $attributes['type']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['file_id' => $this->fileId, 'image_url' => $this->imageUrl, 'type' => $this->type];
    }
}

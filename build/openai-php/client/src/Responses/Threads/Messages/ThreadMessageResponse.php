...
final class ThreadMessageResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        $content = array_map(fn(array $content): ThreadMessageResponseContentTextObject|ThreadMessageResponseContentImageFileObject|ThreadMessageResponseContentImageUrlObject => match ($content['type']) {
        ...
        $attachments = array_map(fn(array $attachment): ThreadMessageResponseAttachment => ThreadMessageResponseAttachment::from($attachment), $attributes['attachments'] ?? []);

...
namespace BackdropOpenAI\OpenAI\Responses\Threads\Messages\Delta;

use BackdropOpenAI\OpenAI\Contracts\ResponseContract;
use BackdropOpenAI\OpenAI\Responses\Concerns\ArrayAccessible;
use BackdropOpenAI\OpenAI\Responses\Threads\Messages\ThreadMessageResponseContentTextAnnotationFileCitationObject;
use BackdropOpenAI\OpenAI\Responses\Threads\Messages\ThreadMessageResponseContentTextAnnotationFilePathObject;
...
final class ThreadMessageDeltaResponseContentText implements ResponseContract
{
    ...
    public static function from(array $attributes): self
    {
        ...
        return new self($attributes['value'] ?? null, $annotations);
    }
    /**
     * {@inheritDoc}
     */

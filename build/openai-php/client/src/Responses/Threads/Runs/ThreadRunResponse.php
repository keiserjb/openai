...
use BackdropOpenAI\OpenAI\Responses\Assistants\AssistantResponseResponseFormat;
...
final class ThreadRunResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        $tools = array_map(fn(array $tool): ThreadRunResponseToolCodeInterpreter|ThreadRunResponseFileSearch|ThreadRunResponseToolFunction => match ($tool['type']) {

...
use BackdropOpenAI\OpenAI\Responses\Threads\Messages\Delta\ThreadMessageDeltaResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\Messages\ThreadMessageResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\Delta\ThreadRunStepDeltaResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponse;
use BackdropOpenAI\OpenAI\Responses\Threads\ThreadResponse;
...
class ThreadRunStreamResponse implements ResponseContract
{
    ...
    public static function from(array $attributes): self
    {
        ...
        $response = match ($event) {
            ...
            // @phpstan-ignore-line
            'thread.run.step.delta' => ThreadRunStepDeltaResponse::from($attributes),
            // @phpstan-ignore-line
            'thread.message.created', 'thread.message.in_progress', 'thread.message.completed', 'thread.message.incomplete' => ThreadMessageResponse::from($attributes, $meta),
            // @phpstan-ignore-line
            'thread.message.delta' => ThreadMessageDeltaResponse::from($attributes),
            // @phpstan-ignore-line

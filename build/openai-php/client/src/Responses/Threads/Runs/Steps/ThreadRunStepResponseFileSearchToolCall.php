...
final class ThreadRunStepResponseFileSearchToolCall implements ResponseContract
{
     ...
     */
    private function __construct(public string $id, public string $type, public array $file_search)
    {
    }
    /**
    ...
    {
        return new self($attributes['id'], $attributes['type'], $attributes['file_search']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['id' => $this->id, 'type' => $this->type, 'file_search' => $this->file_search];
    }
}

...
final class ThreadRunStepResponseCodeInterpreter implements ResponseContract
{
    ...
    {
        $outputs = array_map(fn(array $output): \BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputImage|\BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputLogs => match ($output['type']) {

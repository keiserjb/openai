...
namespace BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\Delta;

use BackdropOpenAI\OpenAI\Contracts\ResponseContract;
use BackdropOpenAI\OpenAI\Responses\Concerns\ArrayAccessible;
use BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseMessageCreationStepDetails;
use BackdropOpenAI\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseToolCallsStepDetails;
...
final class ThreadRunStepDeltaObject implements ResponseContract
{
    ...
    use ArrayAccessible;
    use Fakeable;
    private function __construct(public ThreadRunStepResponseMessageCreationStepDetails|ThreadRunStepResponseToolCallsStepDetails $stepDetails)
    {
    }
    /**
    ...
    {
        return ['step_details' => $this->stepDetails->toArray()];
    }
}

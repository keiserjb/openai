...
final class ThreadRunStepResponseUsage implements ResponseContract
{
    ...
    use ArrayAccessible;
    use Fakeable;
    private function __construct(public int $completionTokens, public int $promptTokens, public int $totalTokens)
    {
    }
    /**
    ...
    {
        return new self($attributes['completion_tokens'], $attributes['prompt_tokens'], $attributes['total_tokens']);
    }
    /**
     * {@inheritDoc}
     */

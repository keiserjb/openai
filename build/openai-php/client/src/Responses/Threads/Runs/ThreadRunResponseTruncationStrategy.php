...
final class ThreadRunResponseTruncationStrategy implements ResponseContract
{
    ...
    use ArrayAccessible;
    use Fakeable;
    private function __construct(public string $type, public ?int $lastMessages)
    {
    }
    /**
    ...
    {
        return new self($attributes['type'], $attributes['last_messages']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['type' => $this->type, 'last_messages' => $this->lastMessages];
    }
}

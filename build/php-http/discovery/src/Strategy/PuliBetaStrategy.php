...
use BackdropOpenAI\Http\Discovery\Exception\PuliUnavailableException;
use BackdropOpenAI\Puli\Discovery\Api\Discovery;
use BackdropOpenAI\Puli\GeneratedPuliFactory;
/**
...
class PuliBetaStrategy implements DiscoveryStrategy
{
    ...
    private static function getPuliFactory()
    {
        if (null === self::$puliFactory) {
            if (!defined('BackdropOpenAI\PULI_FACTORY_CLASS')) {

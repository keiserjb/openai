...
use BackdropOpenAI\GuzzleHttp\Cookie\CookieJar;
use BackdropOpenAI\GuzzleHttp\Exception\GuzzleException;
use BackdropOpenAI\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \BackdropOpenAI\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**

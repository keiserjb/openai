 ...
 */
namespace BackdropOpenAI\Symfony\Component\HttpFoundation\Session\Storage\Handler;

use BackdropOpenAI\Doctrine\DBAL\Configuration;
use BackdropOpenAI\Doctrine\DBAL\DriverManager;
use BackdropOpenAI\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use BackdropOpenAI\Doctrine\DBAL\Tools\DsnParser;
use Relay\Relay;
use BackdropOpenAI\Symfony\Component\Cache\Adapter\AbstractAdapter;
/**
...
class SessionHandlerFactory
{
    public static function createHandler(object|string $connection, array $options = []): AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \BackdropOpenAI\Predis\ClientInterface:

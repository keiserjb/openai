...
class Response
{
    ...
    public function sendHeaders(): static
    {
        ...
        if ($informationalResponse && (!\function_exists('headers_send') && !\function_exists('BackdropOpenAI\headers_send'))) {
    ...
    public function send(): static
    {
        ...
        } elseif (\function_exists('BackdropOpenAI\litespeed_finish_request')) {
